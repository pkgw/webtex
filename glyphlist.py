...
# This is a more-or-less mindless JavaScript-to-Python translation of
# font-compiler/glyphlist.js, which was in turn copied from Mozilla's pdf.js.
...
glyph_to_unicode = {
    ...
    'anbopomofo': u'\u3122',
    'angbopomofo': u'\u3124',
    'angbracketleft': u'\u3008', # This glyph is missing from Adobe's original list.
    'angbracketright': u'\u3009', # This glyph is missing from Adobe's original list.
    'angkhankhuthai': u'\u0E5A',
    'angle': u'\u2220',
    'anglebracketleft': u'\u3008',
    ...
    'cieucuparenkorean': u'\u321C',
    'circle': u'\u25CB',
    'circlecopyrt': u'\u00A9', # This glyph is missing from Adobe's original list.
    'circlemultiply': u'\u2297',
    'circleot': u'\u2299',
    'circleplus': u'\u2295',
    'circlepostalmark': u'\u3036',
    ...
    # this was originally "DingbatsGlyphsUnicode"; I dunno', just merge them.
    ### redundant: 'space': u'\u0020',
    'a1': u'\u2701',
    'a2': u'\u2702',
    'a202': u'\u2703',
